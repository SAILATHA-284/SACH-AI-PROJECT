...
export default function TwitterCheck() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-blue-800 to-purple-900 text-white flex">
      <div className="flex-1 p-4 flex flex-col items-center justify-center">
        ...
        <div className="absolute top-4 left-4">
          <img src="/logo.jpeg" alt="Logo" className="h-32 w-48 rounded-xl" />
        </div>
  ...
  <a
    ...
    className="block w-full mt-2 bg-red-600 hover:bg-red-700 text-white py-2 px-4 rounded text-center"
  >
    🚨 Report Account
  </a>
)}
<a
  href="/Extension.zip"
  download
  className="block w-full bg-yellow-500 hover:bg-yellow-600 text-white py-2 px-4 rounded text-center mt-4"
>
  🧩 Download SACHAI Extension (.zip)
</a>
        ...
        <div className="pt-4 border-t border-gray-700">
          ...
          <p className="text-gray-400 whitespace-pre-wrap">{assistantReply || 'Identify the red flags with the help of AI assistant'}</p>
        </div>
      </div>
    </div>
  );
